...
//     const result = await updateContact(contactId, userId, req.body, {upsert: true});
//     if(!result) {
...
//     const message = result.isNew ? 'Successfully created a contact!' : 'Successfully updated a contact!';
